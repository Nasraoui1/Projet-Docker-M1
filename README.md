...
3. **Surveillance des Pipelines** :
   ...
   - Utilisez l'interface GitLab pour surveiller l'exécution des pipelines, vérifier les rapports de sécurité et consulter les résultats des tests.#   P r o j e t - D o c k e r - M 1  
 